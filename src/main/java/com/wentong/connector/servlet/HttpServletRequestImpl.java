...
public class HttpServletRequestImpl implements HttpServletRequest {
    ...
    public HttpServletRequestImpl(HttpExchangeAdapter httpExchangeAdapter) {
    ...
    public String getParameter(String name) {
        String query = this.httpExchangeAdapter.getRequestURI().getRawQuery();
        if (query != null) {
    ...
    public String getMethod() {
        return httpExchangeAdapter.getRequestMethod();
    }
